...
#define RMW_UXRCE_MAX_OPTIONS 3
#define RMW_UXRCE_MAX_WAIT_SETS 5
#define RMW_UXRCE_MAX_GUARD_CONDITION 3
#define RMW_UXRCE_ENTITY_CREATION_TIMEOUT RMW_UXRCE_ENTITY_CREATION_DESTROY_TIMEOUT
#define RMW_UXRCE_ENTITY_DESTROY_TIMEOUT RMW_UXRCE_ENTITY_CREATION_DESTROY_TIMEOUT
